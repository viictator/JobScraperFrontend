...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0f0f0f] flex items-center justify-center p-4">
            <div className="bg-[#1c1c1c] p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-800">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 bg-[#2c2c2c] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150"
                    ...
                    <button
                        ...
                        className={`w-full py-3 rounded-lg font-semibold shadow-lg transition duration-150 ${
                            isLoading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed'
                        }`}
                    >
                        {isLoading ? (
